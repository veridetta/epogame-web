                        ...
                        @csrf
                         ...
                         <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Kunci:</strong>
                                    <select name="kunci" class="custom-select form-control">
                                        <option selected>Pilih...</option>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="a_opsi" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Gambar Opsi B</strong>
                                    <input type="file" name="images[]" class="form-control">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Gambar Opsi D</strong>
                                    <input type="file" name="images[]" class="form-control">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Opsi D:</strong>
